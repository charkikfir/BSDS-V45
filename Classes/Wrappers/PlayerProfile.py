...
class PlayerProfile:
    def encode(calling_instance, fields, playerData):
        ...
        calling_instance.writeVInt(playerData["vs"])        
        ...
        calling_instance.writeVInt(playerData["pl_rank"]) # Power League Solo Rank #playerData["pl_rank"]

        calling_instance.writeVInt(17)
        calling_instance.writeVInt(0) # Power League Team Rank

        calling_instance.writeVInt(19)
        calling_instance.writeVInt(0) # Club League Rank #playerData["club_rank"]
