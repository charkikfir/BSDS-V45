    ...
    def execute(message, calling_instance, fields):
        ...
        if fields["ClientMajor"] == 44:
            ...
            if Configuration.settings["UseContentUpdater"] == True and fields["ResourceSha"] != contentUpdateInfo[1]:
            	...
            	Messaging.sendMessage(20103, {'Socket': calling_instance.client, 'ErrorID': 10, 'Message': "На сервере ввидутся технические работы! Пожалуйста следите за каналом @bildbruher чтобы получать новости по серверу!", 'FingerprintData': None, 'ContentURL': None}) # Maintance
            
            elif banned == True:
            	Messaging.sendMessage(20103, {'Socket': calling_instance.client, 'ErrorID': 11, 'Message': "Ваш аккаунт был забанен! Если аккаунт был заблокирован случайно, напиши @kulerdev в телеграмм!", 'FingerprintData': None, 'ContentURL': None}) # Ban
            
            elif fields["ClientMajor"] < 44:
            	Messaging.sendMessage(20103, {'Socket': calling_instance.client, 'ErrorID': 8, 'Message': "Хорошая новость! Доступна новая версия Bild Brawl! Скачать обновление можно у нас в телеграме - @bildbruher", 'FingerprintData': None, 'ContentURL': f'https://t.me/bildbruher'}) # Update
